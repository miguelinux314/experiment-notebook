...
class JPEG2000(icompression.WrapperCodec, icompression.LosslessCodec):
	def __init__(self):
	...
	def get_compression_params(self, original_path, compressed_path, original_file_info):
		...
		f"Nprecision={original_file_info['bytes_per_sample']*8} Nsigned={'yes' if original_file_info['signed'] else 'no'}"
