...
class JPEG_XL(icompression.LosslessCodec,icompression.PNGWrapperCodec):
    def __init__(self, quality_0_to_100=100, compression_level=7,
        ...
        Uses jpeg_xl parameter -q and was chosen over -d maxError (defined by butteraugli distance) becuase of slightly better throughput (approx 1.2 Mp/s) under lossless mode
        ...
        icompression.PNGWrapperCodec.__init__(
            ...
            param_dict=dict(quality_0_to_100=quality_0_to_100,compression_level=compression_level), output_invocation_dir=None)
