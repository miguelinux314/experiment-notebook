...
for d in plugin_*; do
  ...
  test -e Makefile.linux && make -f Makefile.linux clean >& /dev/null
  test -e Makefile.linux && ( (make -f Makefile.linux >& ./build_errors.log) || echo "Error building plugin at $d. See ./build_errors.log for more information" )
