...
class JPEGXLPlugin(enb.plugins.PluginMake):
    ...
    authors = ["Ashwin Kumar Gururajan", "Xavier Fernández-Mellado", "Miguel Hernández-Cabronero"]
    ...
    contrib_download_url_name = [
        ("https://github.com/miguelinux/experiment-notebook/blob/master/contrib/jpegxl_0.12.0.zip?raw=true",
         "jpegxl_git.zip")]
